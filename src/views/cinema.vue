<template>
  <div class="cinema">
    <CinemaTopBar/>
    <main>
      <CinemaList v-for="(v,i) in cinemaList" :key="i" :title="v.cinemaName" :address="v.address" :support="v.supportList" :minprice="v.minPrice" :oriprice="v.oriPrice"/>
    </main>
    <BottomBar/>
  </div>
</template>
...
export default {
  mounted(){
    this.getCinema(1)
    document.querySelector("main").addEventListener('scroll', this.scrollBottom)
  },
  methods:{
